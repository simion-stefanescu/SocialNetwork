        ...
        ResetPasswordSendEmailButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(userEmail)){
                    ...
                    Toast.makeText(ResetPasswordActivity.this, "Please write avalid E-mail address", Toast.LENGTH_SHORT).show();
                    ...
                    mAuth.sendPasswordResetEmail(userEmail).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(ResetPasswordActivity.this, "Please check our e-maik", Toast.LENGTH_SHORT).show();
