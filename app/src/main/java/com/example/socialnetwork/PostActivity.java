...
public class PostActivity extends AppCompatActivity {
    ...
    private static final int Galler_Pick = 1;
    ...
    private void ValidatePostInfo() {
        ...
        if(ImageUri == null ){
            ...
            SortingImageToFirebaseStorage();

        }

    }

    private void SortingImageToFirebaseStorage() {
        ...
        StorageReference filePath = PostImageRefrence.child("Post Imagess").child(ImageUri.getLastPathSegment() + postRandomName + ".jpg");
        ...
        filePath.putFile(ImageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(PostActivity.this, "Image Uploaded Succesfulyy to Storage", Toast.LENGTH_SHORT).show();
